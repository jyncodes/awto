      ...
      <strong>Downpayment Required:</strong> ₱{draft.downpayment.toLocaleString()}
          ...
          <div className="payment-right">
            <div className="paypal-section">
              ...
              <form
                action={`https://www.paypal.com/ncp/payment/USM6668E4DKSN?return=https://joventire.com/payment-success&cancel_return=https://joventire.com/payment-failed&custom=${tempLockId}`}
                method="post"
                target="_blank"
